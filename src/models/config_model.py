...
class ConfigModel:
    ...
    def telegram_enabled(self, value):
        self.set("telegram_enabled", bool(value))
    ...
    def telegram_bot_token(self, value):
        self.set("telegram_bot_token", str(value))
    ...
    def telegram_chat_id(self, value):
        self.set("telegram_chat_id", str(value))

    @property
    def telegram_message(self):
        return self._config.get("telegram_message", "")
