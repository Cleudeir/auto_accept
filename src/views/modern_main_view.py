...
class ModernMainView:
    ...
    def _create_content_area(self):
        ...
        self._create_tabbed_settings_panel()
    ...
    def _create_tabbed_settings_panel(self):
        ...
        self.settings_tabview.add("Telegram")

        self.general_tab = self.settings_tabview.tab("General")
        ...
        self._create_modern_audio_settings(parent=self.general_tab)
        self._create_modern_monitor_settings(parent=self.general_tab)
        self._create_modern_telegram_settings(parent=self.telegram_tab)

    def _create_modern_audio_settings(self, parent=None):
    ...
    def _create_modern_telegram_settings(self, parent=None):
        ...
        self.telegram_test_btn = ctk.CTkButton(
            self.telegram_card,
            text="Test Telegram",
